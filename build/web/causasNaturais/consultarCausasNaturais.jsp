        ...
        <div class="container">	
                    ...
                    <tbody>
                        <c:forEach var="causasNaturais" items="${resultado}" >
                            <tr>
                                ...
                                <td><input type="hidden" id="idC" name="idC" value="${causasNaturais.cliente.id}"></td>
                                <td><input type="hidden" id="idV" name="idV" value="${causasNaturais.veiculo.id}"></td>
                                <td><input type="hidden" id="idS" name="idS" value="${causasNaturais.sinistro.id}"></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
            ...
            <div id="quadroDescricao" name="quadroDescricao">  
                ...
                <div class="form-group row">
                    ...
                    <input type="hidden" id="idCliente" name="idCliente" value="${furtoRoubo.cliente.id}">
                    <input type="hidden" id="idVeiculo" name="idVeiculo" value="${furtoRoubo.veiculo.id}">
                    <input type="hidden" id="idSinistro" name="idSinistro" value="${furtoRoubo.sinistro.id}">
                </div>               
