...
<html>
    <head>
        ...
        <script type="text/javascript" src="../style/js/dataFutura.js"></script>
    ...
    <body>
        ...
        <div class="container">	
            ...
            <form action='salvar' method="POST" >    
                ...
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        <input class="form-control" type="text" id="dataInicio" onchange='dataAtual()' name="dataInicio" disabled="false">
                    </div>
                ...
                <div class="form-group row">
                    <label for="valorVeiculo" class="col-2 col-form-label">Valor Veículo</label>
                    <div class="col-2">
                        <input class="form-control" type="text" id="valorVeiculo" name="valorVeiculo" required="true" maxlength="10">
                    </div>                                      
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-2">
                        <select class="form-control" type="text" id="tipoApolice" name="tipoApolice" onchange='regraCalculo(this)' required="true" maxlength="10">
                            <option value=" "> </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-2">
                        <input class="form-control" type="text" id="premio" disabled name="premio" required="true" maxlength="10">
                    </div>
                    <label for="valorApolice" class="col-2 col-form-label">Valor Apólice:</label>
                    <div class="col-2">
                        <input class="form-control" type="text" id="valorApolice" disabled name="valorApolice" required="true" maxlength="10">
                    </div>  
                </div>
                ...
                <input type="hidden" id="dataFutura" name="dataFutura">
                <input type="hidden" id="premioFinal" name="premioFinal">
                <input type="hidden" id="franquiaFinal" name="franquiaFinal">
                <input type="hidden" id="hoje" name="hoje">
            ...
            <script language="javascript">     
                function regraCalculo(el){                    
                    var valorVeiculo = document.getElementsByName('valorVeiculo')[0].value;;
                    ...
                    franquia = franquia.toFixed(2);
                    document.getElementsByName('premio')[0].value = premio;
                    document.getElementsByName('valorApolice')[0].value = franquia;
                    document.getElementById('premioFinal').value = document.getElementsByName('premio')[0].value;
                    document.getElementById('franquiaFinal').value = document.getElementsByName('valorApolice')[0].value;
                }
            </script>
        ...
        <script type="text/javascript">
            ...
            $(window).load(function(){
                ...
                document.getElementById('hoje').value = dataAtual;
            });         
