        ...
        <div class="container">	
            ...
            <div class="row">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach var="cor" items="${resultado}" >
                            <tr>
                                <td>${cor.nome}</td>
                                <td>${cor.documento}</td>
                                <td>${cor.email}</td>
                                <td>${cor.razaoSocial}</td>
                                <td>${cor.telefoneCelular}</td> 
                                <td>${cor.endereco.cep}</td> 
                                <td><a href="preAtualizar?id=${cor.id}&operacao=PREATUALIZAR"><input class="btn btn-secondary" type="button" value="Alterar"></a></td>
                                <td><a href="excluir?id=${cor.id}&operacao=EXCLUIR"><input class="btn btn-danger" type="button" value="Excluir"></a></td>
