                    ...
                    <tbody>
                        <c:forEach var="sinistro" items="${resultado}" >
                            <tr>
                                ...
                                <td>${sinistro.cliente.telefoneCelular}</td>
                                <td>${sinistro.cliente.email}</td>
                                <td>${sinistro.veiculo.modelo}</td> 
                                <td>${sinistro.veiculo.placa}</td> 
                                <td>${sinistro.tipo}</td> 
                                <td><a href="excluir?id=${sinistro.id}&operacao=EXCLUIR"><input class="btn btn-danger" type="button" value="FINALIZAR"></a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
