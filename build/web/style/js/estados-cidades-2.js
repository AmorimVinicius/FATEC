...
function buscaCidades2(e){
   document.querySelector("#cidadeSec").innerHTML = '';
   var cidade_select = document.querySelector("#cidadeSec");
   ...
   if(j_index != -1){
      ...
      json_cidades.estados[j_index].cidades.forEach(function(cidadeSec){
         var cid_opts = document.createElement('option');
         cid_opts.setAttribute('value',cidadeSec)
         cid_opts.innerHTML = cidadeSec;
