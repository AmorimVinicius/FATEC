...
<html>
    ...
    <body>
        ...
        <br/> <br/> <br/> <br/> <br/>
        <div class="container">	
            <h1>Consultar - Sinistro Furto/Roubo</h1>
            <form action='filtrar' method="POST">
                ...
                <input class="btn btn-primary" type="submit" value="Filtrar" onclick="recuperaId();">
                <br/>
            ...
            <div class="row">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach var="furtoRoubo" items="${resultado}" >
                            <tr>
                                <td>${furtoRoubo.atualizacao}</td>
                                <td>${furtoRoubo.descricao}</td> 
                                <td><input type="hidden" id="idC" name="idC" value="${furtoRoubo.cliente.id}"></td>
                                <td><input type="hidden" id="idV" name="idV" value="${furtoRoubo.veiculo.id}"></td>
                                <td><input type="hidden" id="idS" name="idS" value="${furtoRoubo.sinistro.id}"></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
                ...
                <div class="form-group row">
                    ...
                    window.onload = function(){
                        ...
                        if (document.getElementsByName('mensagem')[0].value === mensagem){
                            ...
                            document.typeof('input').style.display = 'none';
                        } 
                        //document.getElementsByName('idCliente')[0].value = "oi";}
                    }
