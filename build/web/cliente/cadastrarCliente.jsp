        ...
        <div class="container">	
            ...
            <form action='salvar' method="POST" >
                ...
                <div class="form-group row">
                    <label for="nome" class="col-2 col-form-label">Nome / Razão Social:</label>
                    <div class="col-4">
                        <input class="form-control" type="text" id="nome" name="nome" required="true" maxlength="100">
                    </div>
                    
                    <label for="documento" class="col-2 col-form-label">Documento:</label>  
                    <div class="col-4">
                        <input class="form-control" type="text" id="documento" name="documento" required="true" maxlength="11">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        <input class="form-control" type="text" id="dataNascimento" name="dataNascimento" maxlength="10">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        <input class="form-control" type="text" id="numero" name="numero" required="true">
                    </div>
