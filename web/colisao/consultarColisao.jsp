...
<html>
    ...
    <body>
        ...
        <div class="container">	
            ...
            <form action='filtrar' method="POST">
                ...
                <c:if test="${mensagem != null}">
                    <br/>
                    <p>${mensagem}</p>
                    <input type="hidden" id="mensagem" name="mensagem" value="infoRN">
                </c:if>
                    ...
                    <tbody>
                        <c:forEach var="colisao" items="${resultado}" >
                            <tr>
                                ...
                                <td>${colisao.mecanica.nome}</td> 
                                <td>${colisao.mecanica.telefone}</td> 
                                <td><input type="hidden" id="idC" name="idC" value="${colisao.cliente.id}"></td>
                                <td><input type="hidden" id="idV" name="idV" value="${colisao.veiculo.id}"></td>
                                <td><input type="hidden" id="idS" name="idS" value="${colisao.sinistro.id}"></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
        ...
        <div id="quadroDescricao" name="quadroDescricao">      
            <form action='salvar' method="POST" >    
                ...
                <div class="form-group row">
                    ...
                    window.onload = function(){
                        ...
                        var mensagem = "infoRN";
                        if (document.getElementsByName('mensagem')[0].value == mensagem){
                            document.getElementById('quadroDescricao').style.display = 'none';
                        }
                         
                        
                        
                        document.getElementById('idCliente').value = document.getElementById('idC').value;
                        document.getElementById('idVeiculo').value = document.getElementById('idV').value;
                        document.getElementById('idSinistro').value = document.getElementById('idS').value;
                    ...
                    <input type="hidden" id="idSinistro" name="idSinistro" value="${resultado.get(0).sinistro.id}">
                </div>               
