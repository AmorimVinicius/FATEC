        ...
        <div class="container">	
            ...
            <div class="row">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach var="clienteTerceiro" items="${resultado}" >
                            <tr>
                                <td>${clienteTerceiro.atualizacao}</td>
                                <td>${clienteTerceiro.descricao}</td> 
                                <td><input type="hidden" id="idC" name="idC" value="${clienteTerceiro.cliente.id}"></td>
                                <td><input type="hidden" id="idV" name="idV" value="${clienteTerceiro.veiculo.id}"></td>
                                <td><input type="hidden" id="idS" name="idS" value="${clienteTerceiro.sinistro.id}"></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
