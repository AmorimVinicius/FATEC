                    ...
                    <tbody>
                        <c:forEach var="clienteTerceiro" items="${resultado}" >
                            <tr>
                                ...
                                <input type="hidden" id="idCliente" name="idCliente" value="${clienteTerceiro.cliente.id}">
                                <input type="hidden" id="idVeiculo" name="idVeiculo" value="${clienteTerceiro.veiculo.id}">
                                <input type="hidden" id="idSinistro" name="idSinistro" value="${clienteTerceiro.sinistro.id}">
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
