...
<html>
    ...
    <body>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="cadastrarIncendio.jsp">Cadastrar Incêndio</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="consultarIncendio.jsp">Consultar Incêndio</a>
                                <div class="dropdown-divider"></div>
        ...
        <br/> <br/> <br/> <br/> <br/>
        <div class="container">	
            <h1>Consultar - Sinistro Incêndio</h1>
            ...
            <div class="row">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach var="incendio" items="${resultado}" >
                            <tr>
                                <td>${incendio.atualizacao}</td>
                                <td>${incendio.descricao}</td> 
                                <td><input type="hidden" id="idC" name="idC" value="${incendio.cliente.id}"></td>
                                <td><input type="hidden" id="idV" name="idV" value="${incendio.veiculo.id}"></td>
                                <td><input type="hidden" id="idS" name="idS" value="${incendio.sinistro.id}"></td>
